package yaydev.notes.app.view.pflockscreen.fragments;
...
import yaydev.notes.app.view.pflockscreen.views.PFCodeView;
...
public class PFLockScreenFragment extends Fragment {
    ...
    private static final String INSTANCE_STATE_CONFIG
            = "yaydev.notes.app.view.pflockscreen.instance_state_config";
